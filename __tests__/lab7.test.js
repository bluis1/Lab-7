describe('Basic user flow for Website', () => {
  ...
  beforeAll(async () => {
    ...
    // Clear old cart data so the tests start from an empty cart
    await page.evaluate(() => {
      localStorage.clear();
    });
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    const allButtonsSayRemove = buttonTexts.every((text) => {
      return text === 'Remove from Cart';
    });
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    const allButtonsSayAdd = buttonTexts.every((text) => {
